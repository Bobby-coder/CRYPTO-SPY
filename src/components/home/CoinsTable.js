    ...
    <>
      <div className="w-[90%] mx-auto my-5 h-10 relative flex items-center">
        <input
          ...
          className="w-full text-[12px] lg:text-[16px] rounded bg-transparent h-full border-solid border-gray-500 border-2 outline-none px-2 hover:border-gray-50 capitalize placeholder:uppercase placeholder:text-[12px] placeholder:tracking-wide placeholder:lg:text-[16px]"
          onChange={(e) => setSearch(e.target.value)}
        />
        <svg
          className="svg-icon search-icon inline-block h-5 w-8 absolute right-1"
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className="text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              <th
                scope="col"
                className="py-2 pl-12 pr-[48px] text-[14px] font-semibold lg:text-[18px]"
              >
                COIN
              </th>
              <th
              ...
              <th
                scope="col"
                className="py-2 text-center px-[30px] text-[14px] font-semibold hidden sm:table-cell lg:text-[18px]"
              >
                CHANGE
              </th>
              <th
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="flex gap-3 items-center justify-start">
                        ...
                        <div className="flex flex-col gap-[1px]">
                          <p className="uppercase text-[12px] lg:text-[16px]">
                            {coinObj.symbol}
                          </p>
                          <p className="text-[12px] lg:text-[16px]">{coinObj.name}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td
                      className={
                        profit > 0
                          ? "py-4 text-center text-[12px] text-green hidden sm:table-cell lg:text-[16px]"
                          : "py-4 text-center text-[12px] text-red hidden sm:table-cell lg:text-[16px]"
                      }
                    >
                      {`${
                    ...
                    <td className="py-4 text-[12px] text-center text-white hidden sm:table-cell lg:text-[16px]">
                      <span>{symbol}</span>{" "}
