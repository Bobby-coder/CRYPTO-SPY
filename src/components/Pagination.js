    ...
    <>
      <div className="w-full flex justify-center my-8">
        <ul className="inline-flex items-center -space-x-px">
          ...
          <li onClick={() => (page < 10) && (setPage(page + 1) (window.scroll(0, 450)) )} className="cursor-pointer block py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            <svg
              aria-hidden="true"
              className="w-5 h-5"
              fill="currentColor"
